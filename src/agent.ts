...
export class WHAgent {
    ...
    constructor(config: AgentConfig) {
        this.config = {
            ...
            skillsDir: config.skillsDir ?? '.hi/skills',
...
export async function createWHAgent(config: AgentConfig): Promise<WHAgent> {
    const agent = new WHAgent(config)
    await agent.init()
    return agent
}